...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{asset ('style/themes/assets/ico/favicon.ico') }}">
    <title>@yield('title')</title>

    <!-- Bootstrap core CSS -->
    <link href="{{asset ('style/themes/dist/css/bootstrap.min.css')}}" rel="stylesheet">
    ...
    <link href="{{asset ('style/themes/assets/css/carousel.css')}}" rel="stylesheet">
  </head>
<!-- NAVBAR
================================================== -->
  <body>
        ...
        <div class="navbar navbar-inverse navbar-static-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index.html">Bootstrap Restaurant
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="{{asset ('style/themes/assets/images/nepali-momo.png')}}" alt="Generic placeholder image">
          <h2>Nepalese MOMO</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="{{asset ('style/themes/assets/images/burger.png')}}" alt="Generic placeholder image">
          <h2>Burger</h2>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. </p>
          <p><a class="btn btn-default" href="#" role="button">&pound;5 Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
		  <img class="img-circle" src="{{asset ('style/themes/assets/images/gorkha-special-chicken.png')}}" alt="Lam Tikka">
	...
	<div id="myCarousel1" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
         <div class="row">
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/salate.png')}}" alt="Generic placeholder image">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/burger.png')}}" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/drinks.png')}}" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
	...
	<div id="myCarousel2" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
         <img src="{{asset ('style/themes/assets/images/chicken.png" alt="Generic placeholder image')}}">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/drinks_lussy.png" alt="Generic placeholder image')}}">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
        ...
        <div class="item">
         <div class="row">
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/chicken_fry.png" alt="Generic placeholder image')}}">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/fish-and-chips.png" alt="Generic placeholder image')}}">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div id="myCarousel3" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/rice.png" alt="Generic placeholder image')}}">
          <h4>Rice</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
        ...
        <div class="item">
         <div class="row">
        <div class="col-lg-4">
          <img src="{{asset ('style/themes/assets/images/courinder.png" alt="Generic placeholder image')}}">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div class="row">
		<div class="col-lg-4">
		<div class="media">
			<a href="menu/"><img src="{{asset ('style/themes/assets/images/nepali-momo.png" alt="nepali-momo')}}"> </a>
		...
		<div class="col-lg-4">
		<div class="media"><a href="menu/"><img src="{{asset ('style/themes/assets/images/gorkha-special-chicken.png')}}" alt="GURKHA SPECIAL CHICKEN"> </a>						
		...
		<div class="col-lg-4">
		<div class="media">
		<a href="menu/"><img src="{{asset ('style/themes/assets/images/lam-tikka.png" alt="Lam Tikka')}}"> </a>
   ...
   <div id="myCarousel4" class="carousel slide" data-ride="carousel">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img src="{{asset ('style/themes/assets/images/fish-and-chips.png" alt="Fish and Chips')}}">
        </div>
      </div>
      </div>
	...
	<div class="item">
      <div class="row featurette">
        ...
        <div class="col-md-5">
		  <img class="img-circle" src="{{asset ('style/themes/assets/images/drinks.png" alt="Generic placeholder image')}}">
        </div>
      </div>
      </div>
	   </div>
    ...
    <script src="{{asset ('style/themes/assets/js/holder.js')}}"></script>
  </body>
</html>
